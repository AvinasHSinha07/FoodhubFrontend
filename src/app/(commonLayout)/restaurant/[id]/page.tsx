...
export default function RestaurantMenuPage() {
  ...
  // Compute dynamic rating based on reviews
                    ...
                    <div className="p-5 pt-4 border-t border-slate-50 mt-auto">
                      {qty === 0 ? (
                        ...
                        <div className="flex items-center justify-between bg-indigo-50 rounded-2xl p-2 border border-indigo-100 h-12">
                          ...
                          <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl bg-indigo-600 shadow-sm hover:bg-indigo-700 text-white" onClick={() => addToCart(meal, provider)}>
